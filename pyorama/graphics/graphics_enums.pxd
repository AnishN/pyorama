ctypedef enum GraphicsItemType:
    ...
    GRAPHICS_ITEM_TYPE_MESH_BATCH
    GRAPHICS_ITEM_TYPE_SPRITE
    GRAPHICS_ITEM_TYPE_SPRITE_BATCH
    GRAPHICS_ITEM_TYPE_BITMAP_FONT
    GRAPHICS_ITEM_TYPE_TEXT
    GRAPHICS_ITEM_TYPE_TEXTURE_GRID_ATLAS
    GRAPHICS_ITEM_TYPE_TILE_MAP
