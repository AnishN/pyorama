...
cpdef Handle index_buffer_create(IndexLayout index_layout, uint8_t[::1] index_data) except *:
    ...
    memory_ptr = bgfx_copy(&index_data[0], index_data.shape[0])
    if index_buffer_ptr.index_layout == INDEX_LAYOUT_UINT16:
        ...
        index_buffer_ptr.num_indices = index_data.shape[0] / sizeof(uint16_t)
        ...
        index_buffer_ptr.num_indices = index_data.shape[0] / sizeof(uint32_t)
    return index_buffer
