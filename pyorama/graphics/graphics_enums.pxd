ctypedef enum GraphicsType:
    GRAPHICS_TYPE_WINDOW
    GRAPHICS_TYPE_VERTEX_FORMAT
    GRAPHICS_TYPE_VERTEX_BUFFER
    GRAPHICS_TYPE_INDEX_BUFFER
    GRAPHICS_TYPE_MESH
    GRAPHICS_TYPE_UNIFORM_FORMAT
    GRAPHICS_TYPE_UNIFORM
    GRAPHICS_TYPE_SHADER
    GRAPHICS_TYPE_PROGRAM
    GRAPHICS_TYPE_IMAGE
    GRAPHICS_TYPE_TEXTURE
    GRAPHICS_TYPE_FRAME_BUFFER
    GRAPHICS_TYPE_VIEW
...
"""
Basic texture formats support.
Most of these are not even in WebGL 1/OpenGL ES 2!
For those platforms, mostly get 8-bit versions (32-bit only with extensions at best)
Not supporting compressed formats or oddball ones (e.g. depth24_stencil8, RB565, etc)
"""
