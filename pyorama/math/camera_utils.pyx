from pyorama.app cimport graphics#needed for clipspace auto-detection
...
cdef class CameraUtils:
    ...
    @staticmethod
    def look(Mat4 out, Vec3 eye, Vec3 dir_, Vec3 up, bint right_handed=graphics.right_handed, bint homogeneous_depth=graphics.homogeneous_depth):
    ...
    @staticmethod
    def look_any_up(Mat4 out, Vec3 eye, Vec3 dir_, Vec3 up, bint right_handed=graphics.right_handed, bint homogeneous_depth=graphics.homogeneous_depth):
    ...
    @staticmethod
    def look_at(Mat4 out, Vec3 eye, Vec3 center, Vec3 up, bint right_handed=graphics.right_handed, bint homogeneous_depth=graphics.homogeneous_depth):
    ...
    @staticmethod
    def orthographic(Mat4 out, float left, float right, float bottom, float top, float near_z, float far_z, bint right_handed=graphics.right_handed, bint homogeneous_depth=graphics.homogeneous_depth):
    ...
    @staticmethod
    def orthographic_box(Mat4 out, Box3 box, bint right_handed=graphics.right_handed, bint homogeneous_depth=graphics.homogeneous_depth):
    ...
    @staticmethod
    def orthographic_box_pad(Mat4 out, Box3 box, float padding, bint pad_z, bint right_handed=graphics.right_handed, bint homogeneous_depth=graphics.homogeneous_depth):
    ...
    @staticmethod
    def orthographic_cube(Mat4 out, float aspect, float size, bint right_handed=graphics.right_handed, bint homogeneous_depth=graphics.homogeneous_depth):
    ...
    @staticmethod
    def orthographic_unit(Mat4 out, float aspect, bint right_handed=graphics.right_handed, bint homogeneous_depth=graphics.homogeneous_depth):
    ...
    @staticmethod
    def perspective(Mat4 out, float fovy, float aspect, float near_z, float far_z, bint right_handed=graphics.right_handed, bint homogeneous_depth=graphics.homogeneous_depth):
    ...
    @staticmethod
    def perspective_decompose(Mat4 m, Box3 box, bint right_handed=graphics.right_handed, bint homogeneous_depth=graphics.homogeneous_depth):
    ...
    @staticmethod
    def perspective_decompose_far(Mat4 m, bint right_handed=graphics.right_handed, bint homogeneous_depth=graphics.homogeneous_depth):
    ...
    @staticmethod
    def perspective_decompose_near(Mat4 m, bint right_handed=graphics.right_handed, bint homogeneous_depth=graphics.homogeneous_depth):
    ...
    @staticmethod
    def perspective_decompose_x(Mat4 m, Vec2 v, bint right_handed=graphics.right_handed, bint homogeneous_depth=graphics.homogeneous_depth):
    ...
    @staticmethod
    def perspective_decompose_y(Mat4 m, Vec2 v, bint right_handed=graphics.right_handed, bint homogeneous_depth=graphics.homogeneous_depth):
    ...
    @staticmethod
    def perspective_decompose_z(Mat4 m, Vec2 v, bint right_handed=graphics.right_handed, bint homogeneous_depth=graphics.homogeneous_depth):
    ...
    @staticmethod
    def perspective_move_far(Mat4 out, float delta_far, bint right_handed=graphics.right_handed, bint homogeneous_depth=graphics.homogeneous_depth):
    ...
    @staticmethod
    def perspective_resize(Mat4 out, float aspect, bint right_handed=graphics.right_handed, bint homogeneous_depth=graphics.homogeneous_depth):
    ...
    @staticmethod
    def perspective_plane_sizes(Mat4 m, float fovy, Vec2 near, Vec2 far, bint right_handed=graphics.right_handed, bint homogeneous_depth=graphics.homogeneous_depth):
    ...
    @staticmethod
    def perspective_unit(Mat4 out, float aspect, bint right_handed=graphics.right_handed, bint homogeneous_depth=graphics.homogeneous_depth):
        CameraUtils.c_perspective_unit(&out.data, aspect, right_handed, homogeneous_depth)

    @staticmethod
    cdef void c_project(Vec3C *out, Vec3C *pos, Mat4C *m, Vec4C *viewport, bint homogeneous_depth=graphics.homogeneous_depth) nogil:
    ...
    @staticmethod
    def project(Vec3 out, Vec3 pos, Mat4 m, Vec4 viewport, bint homogeneous_depth=graphics.homogeneous_depth):
        CameraUtils.c_project(&out.data, &pos.data, &m.data, &viewport.data, homogeneous_depth)

    @staticmethod
    cdef void c_unproject(Vec3C *out, Vec3C *pos, Mat4C *m, Vec4C *viewport, bint homogeneous_depth=graphics.homogeneous_depth) nogil:
        cdef Mat4C inv
    ...
    @staticmethod
    def unproject(Vec3 out, Vec3 pos, Mat4 m, Vec4 viewport, bint homogeneous_depth=graphics.homogeneous_depth):
        CameraUtils.c_unproject(&out.data, &pos.data, &m.data, &viewport.data, homogeneous_depth)
    
    @staticmethod
    cdef void c_unproject_inv(Vec3C *out, Vec3C *pos, Mat4C *m, Vec4C *viewport, bint homogeneous_depth=graphics.homogeneous_depth) nogil:
    ...
    @staticmethod
    def unproject_inv(Vec3 out, Vec3 pos, Mat4 m, Vec4 viewport, bint homogeneous_depth=graphics.homogeneous_depth):
